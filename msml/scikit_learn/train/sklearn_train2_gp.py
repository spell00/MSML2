...
if __name__ == "__main__":
    ...
    parser.add_argument('--transductive', type=float, default=1)
    ...
    if args.inference_inputs and args.combat_data and args.combat:
        args.inference_inputs = f"{args.input_dir}/mz{args.mz}/rt{args.rt}/{args.spd}spd/" \
                                ...
                                f"/log{args.log2}/valid/{args.run_name}/BACT_inference_inputs_{args.run_name}_combat.csv"
    ...
    if args.drop_lows == "train":
        ...
        valid_data, valid_labels, valid_batches, valid_lows, valid_highs, valid_vhighs, valid_blks = new_load_data(args.valid_input, binary=args.binary,
                                                                            min_mz=args.min_mz, min_rt=args.min_rt)

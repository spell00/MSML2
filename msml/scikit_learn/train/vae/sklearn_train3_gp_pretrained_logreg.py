...
from msml.dl.models.pytorch.utils.dataset import MSDataset, MSCSV
...
class Train:
    def __init__(self, path, model, model_name='resnet18', get_data_function=MSCSV, n_channels=1, verbose=1, cv=5,
                 n_epochs=100, batch_size=2, epochs_per_checkpoint=1, aeopt='mse', save=True, load=True, early_stop_val=5000,
    ...
    def train(self, params):
        ...
        cnn = getattr(models, self.model_name)(pretrained=True)

...
:TRAIN_AE
python msml/dl/train/mlp/train_ae_classifier_msms.py --ms_level=%ms_level% --triplet_loss=1 --predict_tests=1 --dann_sets=0 --balanced_rec_loader=0 --dann_plates=0 --zinb=1 --variational=0 --use_valid=1 --use_test=1 --path=../../resources --experiment=old_data

...
IF [%ms_level%]==[] (set ms_level=2)
IF [%spd%]==[] (set spd=200)
IF [%mz_bin%]==[] (set mz_bin=0.01)
IF [%rt_bin%]==[] (set rt_bin=0.1)
...
:TRAIN_AE
python msml/dl/train/mlp/train_ae_classifier_msms.py --mz_bin=%mz_bin% --rt_bin=%rt_bin% --mz_bin_post=%mz_bin_post% --rt_bin_post=%rt_bin_post% --ms_level=%ms_level% --triplet_loss=1 --predict_tests=1 --dann_sets=0 --balanced_rec_loader=0 --dann_plates=0 --zinb=1 --variational=0 --use_valid=1 --use_test=1 --path=../../resources --experiment=old_data

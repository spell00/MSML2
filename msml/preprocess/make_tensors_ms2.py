...
if 'logs' not in os.listdir():
    os.makedirs('logs')
logging.basicConfig(filename='logs/make_tensors_ms2_split.log', filemode='w',
...
def parse_arguments():
    ...
    dir_input = f"{script_dir}/{input_dir}/mz{args.mz_bin}/rt{args.rt_bin}/{args.spd}spd/ms2/all/"
